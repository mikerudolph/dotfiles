...
desired_macos_applications() {
  ...
  declare_macos_cask "JetBrains Mono Nerd Font" "font-jetbrains-mono-nerd-font" ""
  ...
  declare_macos_cask "Wispr Flow" "wispr-flow" "/Applications/Wispr Flow.app"
  declare_macos_cask "Granola" "granola" "/Applications/Granola.app"
  ...
  report_manual "Open Wispr Flow, sign in, and approve Microphone and Accessibility access"
  report_manual "Open Granola, connect the intended calendar, and approve Microphone and Screen & System Audio Recording access"
